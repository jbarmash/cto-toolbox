...
ActiveRecord::Schema.define(:version => 20120312072229) do
  ...
  create_table "toolboxes_tools", :id => false, :force => true do |t|
    t.integer "tool_id"
    t.integer "toolbox_id"
  end

  create_table "toolboxes_users", :id => false, :force => true do |t|
    t.integer "user_id"
    t.integer "toolbox_id"
  end
  ...
  create_table "tools_users", :id => false, :force => true do |t|
    t.integer "user_id"
    t.integer "tool_id"
  end
  ...
  create_table "users_tools", :id => false, :force => true do |t|
    t.integer "user_id"
    t.integer "tool_id"
  end
